...
+ (NSBundle *)bundle {
	// When built with SPM, resources are in a separate bundle named
	// "LetsMove_LetsMove.bundle" located alongside the compiled code.
	NSBundle *classBundle = [NSBundle bundleForClass:self];
	NSURL *resourceBundleURL = [classBundle URLForResource:@"LetsMove_LetsMove" withExtension:@"bundle"];
